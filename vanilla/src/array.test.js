...
describe('pure actions', () => {
    ...
    describe('forEach', () => {
        ...
        test('forEach execute a function on each element', () => {
            ...
            myArray.forEach(function (element) { myUpperArray.push(element.toUpperCase()); });
        ...
        test('forEach get index as additional parameter', () => {
            ...
            myArray.forEach(function (element, index) { myNewArray.push('@' + index + ': ' + element); });
...
describe('impure actions', () => {
    ...
    describe('sort', () => {
        ...
        test('use sorting function', () => {
            ...
            myArray.sort(function equals(val1, val2) { return - 1 * (val1 - val2)});
