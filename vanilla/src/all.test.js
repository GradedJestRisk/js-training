describe('ternary', () => {
    ...
    test('general form ', () => {
        ...
        const predicate = function (result) { return result };
        const value_if_true = function () { return 1 };
        const value_if_false = function () { return 2 };
        let sideEffect = 'enabled';    
    ...
    test('is a functional operator ', () => {
        ...
        const predicate = function () { return true };
        const value_if_true = function () { return 1 };
        const value_if_false = function () { return 2 };
    ...
    test('side effect (smell)', () => {
        ...
        const check_state = function (result) { firstSideEffect = 'modified'; return true; };
        const make_side_effect = function () { secondSideEffect = 'modified too'; return 1 };
       
        let firstSideEffect  = 'enabled';    
        let secondSideEffect = 'enabled too';    
        
        let aResult = check_state(88)
            ? make_side_effect()
            : 33;

        expect(firstSideEffect).toBe('modified');
        expect(secondSideEffect).toBe('modified too');
